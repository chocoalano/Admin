          ...
          <v-card>
            ...
            <v-card-text>
              <v-alert dense outlined type="error" v-if="errors.length > 0">
                {{ errors }} <strong>please</strong> be more careful in <strong>creating </strong> of page
              </v-alert>
...
export default {
  ...
  computed: {
    ...
    options: {
      get: function () {
        return this.$store.state.page.options
      },
      set: function (value) {
        this.$store.commit('page/SET_OPTIONS', value)
      },
    },
    loading: {
      get: function () {
      ...
      set: function (value) {
        this.$store.commit('page/SET_LOADING', value)
      },
    },
    ...
    dialog: {
      ...
      set: function (value) {
        this.$store.commit('page/SET_DIALOG', value)
      },
    },
    dialogDelete: {
      get: function () {
        return this.$store.state.page.dialogDelete
      },
      set: function (value) {
        this.$store.commit('page/SET_DIALOG_DELETE', value)
      },
    },
    formIndex: {
      get: function () {
  ...
  watch: {
    ...
    formItem(e) {
      this.$store.commit('page/SET_FORM_INDEXS', e)
    },
  },
  mounted() {
    this.getDataFromApi()
  ...
  methods: {
    ...mapActions('page', ['Index', 'Show', 'Update', 'Store', 'Delete']),
    ...
    editItem(item) {
      this.$store.commit('page/SET_FORM_INDEX', item)
      this.Show().then(res => {
        const form = {
        ...
        this.$store.commit('page/SET_FORM', form)
      })
      this.dialog = true
    },
    ...
    close() {
      this.$store.commit('page/SET_FORM_INDEX', -1)
